        ...
        <div class="req-hero-info">
          ...
          <div class="req-quick-specs">
            <div class="spec-box">
              ...
              <span class="spec-val highlight">$1.250.000</span>
            </div>
            <div class="spec-box">
      ...
      <div class="requisitos-card glass-panel">
        ...
        <div class="requisitos-grid" style="margin-bottom: 1.5rem;">
          <div class="req-item">
            ...
            <div>
              ...
              <span>$1.250.000 (primer mes de alquiler)</span>
            </div>
          </div>
          <div class="req-item">
            <div class="req-check">✓</div>
            <div>
              ...
              <span>$1.250.000 (garantía contractual)</span>
            </div>
          </div>
          <div class="req-item">
            <div class="req-check">✓</div>
            <div>
              ...
              <span>$1.250.000 (honorarios profesionales de corretaje)</span>
            </div>
          </div>
          <div class="req-item">
            <div class="req-check">✓</div>
        ...
        <div style="background: rgba(52, 211, 153, 0.1); border: 1px solid rgba(52, 211, 153, 0.35); padding: 1.25rem 1.5rem; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem;">
          <div>
            ...
            <strong style="font-size: 1.35rem; color: #ffffff;">TOTAL: $3.750.000</strong>
          </div>
      ...
      <div class="req-hero-grid">
        ...
        <div class="req-hero-info">
          ...
          <div class="req-quick-specs">
            <div class="spec-box">
              <span class="spec-label">Canon Mensual</span>
              <span class="spec-val highlight">$750.000</span>
            </div>
            <div class="spec-box">
      ...
      <div class="requisitos-card glass-panel">
        ...
        <div class="requisitos-grid" style="margin-bottom: 1.5rem;">
          <div class="req-item">
            ...
            <div>
              <strong>Mes de Ingreso</strong>
              <span>$750.000 (primer mes de alquiler adelantado)</span>
            </div>
          </div>
          <div class="req-item">
            <div class="req-check">✓</div>
            <div>
              ...
              <span>$750.000 (depósito en garantía contractual)</span>
            </div>
          </div>
          <div class="req-item">
            <div class="req-check">✓</div>
            <div>
              <strong>Mes de Honorarios</strong>
              <span>$750.000 (honorarios por intervención profesional)</span>
            </div>
          </div>
        </div>
        ...
        <div style="background: rgba(52, 211, 153, 0.1); border: 1px solid rgba(52, 211, 153, 0.35); padding: 1.25rem 1.5rem; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem;">
          <div>
            ...
            <strong style="font-size: 1.35rem; color: #ffffff;">TOTAL: $2.250.000</strong>
          </div>
